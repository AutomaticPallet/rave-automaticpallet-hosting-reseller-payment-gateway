# Rave Automatic Pallet Web Host Reseller PHP Payment Integration Kit
Flutterwave's Rave PHP payment gateway integration kit for Automatic Pallet's white label web host reseller platform. Become the "Web Host" with Nigeria's leading web host resseller. Get your web hosting business started instantly at no cost and accept payment using this Rave PHP payment gateway integration kit.
